...
|---|---|---|
| **64 Hz fixed game loop** | `web/scene.json` → `"fixedHz": 64` | The sim ticks at a fixed 64 Hz, independent of render frame rate. |
...
Preview, `qube deploy`, or a plain web server. You can also open `web/index.html`
over any local static server.
